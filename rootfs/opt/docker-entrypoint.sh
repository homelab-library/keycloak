...
# This is a modified version of jboss's keycloak entrypoint from here: https://github.com/keycloak/keycloak-containers/blob/master/server/tools/docker-entrypoint.sh
...
SYS_PROPS="-Djava.net.preferIPv4Stack=true -Djava.net.preferIPv6Addresses=false "
